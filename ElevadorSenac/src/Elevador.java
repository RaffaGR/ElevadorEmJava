public class Elevador {
  ...
  public Elevador(
    String ElevadorEscolhidoProps,
    int andarAtualProps,
    int totalAndaresProps,
    String[] andaresAtendidosProps,
    int capacidadeMaximaPessoasProps,
    int capacidadeMaximaPesoProps,
    int pessoasPresentesProps
  ) {
  ...
  public int Sai_pessoa() {
    int reduzidas = -1;
    if (
      this.pessoasPresentes < this.capacidadeMaximaPessoas &&
      ...
      System.out.println(
        "Não tem ninguem no elevador, não tem como alguem sair."
      );
    }
  ...
  public void Sobe_elevador() {
    ...
    if (
      ...
      this.andarAtual >= -1 &&
      this.ElevadorEscolhido == "Átrio" ||
      this.ElevadorEscolhido == "Biblioteca"
    ) {
      if (
        this.andarAtual == -1 || this.andarAtual == 0 || this.andarAtual == 4
      ) {
        this.andarAtual++;
        System.out.println("O elevador subiu 1 andar");
        infoElevador();
      } else if (this.andarAtual == 1) {
        this.andarAtual += 3;
    ...
    // Entrada
      ...
      this.andarAtual >= -1 &&
      this.andarAtual < 5 &&
      this.ElevadorEscolhido == "Entrada"
    ) {
      if (this.andarAtual == -1 || this.andarAtual == 2) {
        this.andarAtual++;
        System.out.println("O elevador subiu 1 andar");
        infoElevador();
      } else if (this.andarAtual == 0 || this.andarAtual == 3) {
        this.andarAtual += 2;
        System.out.println("O elevador subiu 3 andares");
        infoElevador();
      } else {
  ...
  public void Desce_elevador() {
    ...
    if (
      ...
      if (
        this.andarAtual == 0 || this.andarAtual == 1 || this.andarAtual == 5
      ) {
        this.andarAtual--;
        System.out.println("O elevador desceu 1 andar");
        infoElevador();
      } else if (this.andarAtual == 4) {
        this.andarAtual -= 3;
    ...
    // Entrada
      ...
      if (this.andarAtual == 0 || this.andarAtual == 3) {
        this.andarAtual--;
        System.out.println("O elevador subiu 1 andar");
        infoElevador();
      } else if (this.andarAtual == 2 || this.andarAtual == 5) {
        this.andarAtual -= 2;
        System.out.println("O elevador subiu 3 andares");
        infoElevador();
      } else {
  ...
  public void infoPessoas() {
    switch (this.andarAtual) {
      case -1:
        System.out.printf(
          "O total de pessoas nesse elevador é igual a %d\n",
          pessoasPresentes
        );
        break;
      case 0:
  ...
  public void infoElevador() {
    switch (this.andarAtual) {
      case -1:
        System.out.println(
          "Andar atual: " + this.andaresAtendidos[this.andarAtual + 1]
        );
        break;
      case 0:
